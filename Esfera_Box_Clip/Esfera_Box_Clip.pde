...
class Pelo
{
  ...
  void dibujar() {
    ...
    float off = (noise(millis() * 0.0005, sin(phi))-0.5) * 0.7; //Aumentei o efeito de "vento" no capim, no exemplo padrão era * 0.3
    float offb = (noise(millis() * 0.0007, sin(z) * 0.01)-0.5) * 0.7;
