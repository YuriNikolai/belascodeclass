...
int[] cores = {255, 0, 120};
//exemplo de array criado com 8 espaços vazios, para serem preenchidos automáticamente com código em um for loop:
...
void draw() {
  ...
  //método acima demonstra a compatibilidade de inicializar elementos com arrays e for loops, 
  //ao contrário de usar apenas arrays com inicialização manual como no exemplo abaixo:
